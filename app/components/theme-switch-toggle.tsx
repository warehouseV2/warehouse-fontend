  ...
  return (
    <div className="tw-flex">
      <button
        ...
        className="tw-border tw-rounded-md tw-border-gray-300 tw-w-11 tw-items-center tw-flex tw-justify-center"
      >
        <IconLightUp
          className={`tw-p-[6px] ${theme === "light" && "tw-hidden"}`}
        />
...
function IconLightUp(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
